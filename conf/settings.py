...
"""
#add import os bc we're using it below
import os
...
# dj_database_url    need to install this!
...
AUTH_USER_MODEL = 'accounts.User'  #overriding djangos default user. Best practice to always do this. Allows you to customize the user model
...
# databases: if i have a database
